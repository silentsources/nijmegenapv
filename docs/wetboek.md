...
| | |
|---|---|
| Overheidsorganisatie      | Hoge Raad Lemon |
| Officiële naam            | Algemeen Wetboek Lemon |
| Citeertitel               | Wetboek Lemon |
...
1. Het Wetboek Lemon (verder aangeduid als WNMRP) is leidend voor alle beschreven gevallen, waarbij als aanvulling het Nederlands Recht van toepassing is.
2. Het WNMRP heeft betrekking op het vaste land, de gemeente, en de stad Lemon.
3. Het WNMRP is nauw verweven met de Algemene Plaatselijke Verordening Lemon (APV). De APV dient echter als een indicerend kader voor eventuele bestraffing in-game (“in RP”) en is verder bedoeld voor het afhandelen van straffen buiten de RP om.
...
3. Minderjarigen worden binnen Lemon op dezelfde manier behandeld als volwassenen. Alle bepalingen, straffen en dergelijke zijn ook van toepassing op hen. Minderjarigen hebben dezelfde rechten en plichten als volwassenen. Het jeugdstrafrecht is in Lemon niet van toepassing.
...
3. Geldige redenen voor inbeslagname zijn:
    1. Plegen van een strafbaar feit uit het wetboek van Lemon waarbij het goed direct of indirect betrokken is, behalve fout parkeren en een snelheidsovertreding met uitzondering zoals beschreven in lid E van dit artikel;
...
---------------------
*Wetboek Lemon is opgesteld uit naam van de Hoge Raad, bedoeld voor de gemeente en de stad “Lemon”, opgetekend door FiveM Hub.*